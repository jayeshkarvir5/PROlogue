...
public class databaseConnection {
	...
	//**********************************************************************************
	   ...
	   public static void insertDataRequirements(int positionid, String positionname,int gitactivity, int competitive,String positionrequirements){
		   connect();
		   PreparedStatement pst=null;
		   try {		
			   pst=conn.prepareStatement("INSERT INTO recruiterrequirements VALUES(?,?,?,?,?);");
			   pst.setInt(1,positionid);//puts the regno in the 1st posn
		...
		*/
		...
		//	insertDataCandidate(561,"Yash Naik","yas23456hna452r3i2k24906@gmail.com","yashnaik2909","YashAndonia","andonia2","yashnaik2406","JAVA, CPP");
			//insertDataRequirements(1,"Intern",8,9,"lol");
			System.out.println(selectCertainData("recruiterrequirements", 1, "positionrequirements"));
