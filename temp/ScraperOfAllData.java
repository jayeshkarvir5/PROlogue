...
public class ScraperOfAllData {
	...
	//github:
			...
			public static int codeForcesRanking(String account_name) {
				try{
				UserAgent x=new UserAgent();

				x.settings.autoSaveAsHTML=true;		
				String url="http://www.codeforces.com/profile/"+account_name;
		        x.visit(url);
		        Element uno=x.doc.findFirst("<div class=userbox>").findFirst("<ul>").findFirst("<span>");
		       	String rating=uno.getChildText();
