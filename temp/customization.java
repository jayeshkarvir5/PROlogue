...
public class customization extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int posNo=databaseConnection.totalPostings()+1;
		databaseConnection.insertDataRequirements(posNo,positionName,Integer.parseInt(GitHubActivity),Integer.parseInt(CPActivity),keyValue);
	}
